        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
          ...
          <div className="px-2 text-center sm:text-left" data-aos="fade-up">
              ...
              <ul className="mt-8 space-y-0 text-sm">
                <Link to="https://www.instagram.com/baliconnectionservices/" icon="fa-brands fa-instagram" name="baliconnectionservices" isFooter="yes"/>
                ...
                <Link to="https://wa.me/6281807082004" icon="fa-solid fa-phone" name="+62 (0) 82108-702-004" isFooter="yes"/>
